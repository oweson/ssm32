...
public class CustomerController {
	...
	//修改保存2
	@RequestMapping(value="/customer/updats.action")
	public @ResponseBody
	String Updatss(Customer customer){
		customerService.updateSbByIds(customer);
		return "ok";
	}
	/*//删除
	...
	@RequestMapping(value="/customer/delete.action")
	public 
	@ResponseBody String delete(Integer id){
		customerService.deleteAllThingInth(id);
		return "ok";
	}
