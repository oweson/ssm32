...
<body>
	<form action="${pageContext.request.contextPath }/pps.action"
		method="get">
	...
	<form action="${pageContext.request.contextPath }/delAll.action"
		method="post">
		查询条件：
		...
		<table width="100%" border=1 bgcolor="yellow">
			...
			<c:forEach items="${itemList }" var="item">
				<tr>
					...
					<td bgcolor="pink"><a
						href="${pageContext.request.contextPath }/delOne.action?id=${item.id}">删除</a></td>
					<td bgcolor="red"><a
						href="${pageContext.request.contextPath }/itemEdit.action?id=${item.id}">增加</a></td>
